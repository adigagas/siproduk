...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jan 2021 pada 03.20
...
INSERT INTO `tb_dokumen` (`id_dokumen`, `berita_acara`, `spk`, `kuitansi_siplah`, `surat_tagihan`, `kuitansi_araya`, `faktur_pembayaran_pajak`, `bukti_pembayaran`, `NPWP`, `id_billing`, `id_transaksi`) VALUES
(1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '202001141609097890');
...
INSERT INTO `tb_pembeli` (`id_pembeli`, `nama_pembeli`, `provinsi`, `kota`, `kode_pos`, `alamat_lengkap`) VALUES
...
INSERT INTO `tb_transaksi` (`id_transaksi`, `tanggal`, `waktu`, `grand_total`, `id_pembeli`) VALUES
('202001141609097890', '2021-01-15', '05:00:00', 377500, 'CUST20200114160909');
...
--
ALTER TABLE `tb_dokumen`
  MODIFY `id_dokumen` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
