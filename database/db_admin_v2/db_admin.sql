...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Des 2020 pada 16.00
...
(1, 'SIPLAH BLIBLI', 'https://siplah.blibli.com/product/acer-aspire-e5-475g/SCDB-0005-01674', 6900000, 9, '2020-12-29', '01:27:00', 2, 2),
...
--
ALTER TABLE `tb_kategori`
  MODIFY `id_kategori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT untuk tabel `tb_ketersediaan`
--
ALTER TABLE `tb_ketersediaan`
  MODIFY `id_ketersediaan` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
